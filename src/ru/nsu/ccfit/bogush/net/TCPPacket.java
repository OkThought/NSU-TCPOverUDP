...
class TCPPacket {
    ...
    private static byte byteAtPos (long x, int pos) { return (byte) (x >> 8 * pos); }

    private static byte byte7 (long x) { return (byte) (x >> 56); }
    private static byte byte6 (long x) { return (byte) (x >> 48); }
    private static byte byte5 (long x) { return (byte) (x >> 40); }
    private static byte byte4 (long x) { return (byte) (x >> 32); }
    private static byte byte3 (long x) { return (byte) (x >> 24); }
    private static byte byte2 (long x) { return (byte) (x >> 16); }
    private static byte byte1 (long x) { return (byte) (x >>  8); }
    private static byte byte0 (long x) { return (byte) (x      ); }

    private static byte setFlagActive(byte b, byte flag) { return (byte) (b | flag); }
    private static byte setFlagInactive(byte b, byte flag) { return (byte) (b & ~flag); }
    ...
    private static boolean getFlag(byte b, byte flag) { return (b & flag) != 0; }
    ...
    boolean isSYN() { return getFlag(SYN); }

    void setSYN(boolean value) {
        setFlag(SYN, value);
    }

    boolean isFIN() { return getFlag(FIN); }
